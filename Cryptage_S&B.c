...
void decryptage() // Fonction decryptage
{
	...
	while(n != i)
	{
		...
		while(alphabet != 26)
		{
			printf("%c, %c\n", texte[n], alphabetMin[alphabet]);
			if(texte[n] == alphabetMin[alphabet])
			{
				caractere = 1;
			}
		...
		if(caractere != 1)
		{
			...
			while(alphabet != 26)
			{
				printf("%c, %c\n", texte[n], alphabetMax[alphabet]);
				if(texte[n] == alphabetMax[alphabet])
				{
					caractere = 2;
				}
		...
		if(caractere != 1 && caractere != 2)
		{
			...
			while(alphabet != 24)
			{
				printf("%c, %c\n", texte[n], symboles[alphabet]);	
				if(texte[n] == symboles[alphabet])
				{
					caractere = 3;
				}
		...
		printf("alphabet vaut : %d\n", alphabet);
		printf("caractere vaut : %d\n", caractere);
		...
		switch(caractere)
		{
			case 1:
				...
				while(ascii != 0)
				{
					...
					texte[k] = alphabetMin[k];
					printf("\ntexte[k] = %c, alphabetMin[k] = %c\n", texte[k], alphabetMin[k]);
